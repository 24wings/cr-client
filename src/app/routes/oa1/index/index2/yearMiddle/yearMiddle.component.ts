...
@Component({
  selector: 'oa1-index-index2-yearMiddle',
  templateUrl: './yearMiddle.component.html',
  styleUrls: ['./yearMiddle.component.css'],
})
export class Oa1IndexIndex2yearMiddleComponent {
  constructor(
